...
class t_delphi7_generator : public t_oop_generator
{
  public:
    t_delphi7_generator(
        t_program* program,
...
bool t_delphi7_generator::find_keyword( std::map<std::string, int>& keyword_map, std::string name) {
  int len = name.length();
...
std::string t_delphi7_generator::normalize_name( std::string name, bool b_method, bool b_exception_method) {
  string tmp( name );
...
void t_delphi7_generator::create_keywords() {
...
void t_delphi7_generator::add_delphi_uses_list( string unitname){
...
void t_delphi7_generator::init_generator() {
  indent_impl_ = 0;
...
void t_delphi7_generator::close_generator() { 
...
void t_delphi7_generator::generate_typedef(t_typedef* ttypedef) {
...
bool t_delphi7_generator::is_fully_defined_type( t_type* ttype) {
...
void t_delphi7_generator::add_defined_type( t_type* ttype) {
  // mark as known type
...
void t_delphi7_generator::init_known_types_list() {
  // known base types
...
void t_delphi7_generator::generate_enum(t_enum* tenum) {
  has_enum = true;
  indent_up();
  indent(s_enum) <<
...
void t_delphi7_generator::generate_consts(std::vector<t_const*> consts) {
  if (consts.empty()){
    return;
  }
...
void t_delphi7_generator::print_private_field(std::ostream& out, string name, t_type* type, t_const_value* value) {
  (void) value;
  indent(out) << "class var F" << name << ": " << type_name(type) << ";" << endl;
}

void t_delphi7_generator::print_const_prop(std::ostream& out, string name, t_type* type, t_const_value* value) {
  (void) value;
  indent(out) << "class property " << name << ": " << type_name(type) << " read F" << name << ";" << endl;
}

void t_delphi7_generator::print_const_value( std::ostream& vars, std::ostream& out, string name, t_type* type, t_const_value* value) {
...
void t_delphi7_generator::initialize_field(std::ostream& vars, std::ostream& out, string name, t_type* type, t_const_value* value) {
  print_const_value( vars, out, name, type, value );
}

void t_delphi7_generator::finalize_field(std::ostream& out, string name, t_type* type, t_const_value* value , string cls_nm) {
  (void) out;
  (void) name;
  (void) type;
  (void) value;
...
string t_delphi7_generator::render_const_value(ostream& vars, ostream& out, string name, t_type* type, t_const_value* value) {
  (void) name;
...
void t_delphi7_generator::generate_struct(t_struct* tstruct) {
  generate_delphi_struct(tstruct, false);
}

void t_delphi7_generator::generate_xception(t_struct* txception) {
  generate_delphi_struct(txception, true);
}

void t_delphi7_generator::generate_delphi_struct(t_struct* tstruct, bool is_exception) {
  indent_up();
...
void t_delphi7_generator::generate_delphi_struct_impl( ostream& out, string cls_prefix, t_struct* tstruct, bool is_exception, bool is_result, bool is_x_factory) {
...
void t_delphi7_generator::print_delphi_struct_type_factory_func(  ostream& out, t_struct* tstruct) {
...
void t_delphi7_generator::generate_delphi_struct_type_factory( ostream& out, string cls_prefix, t_struct* tstruct, bool is_exception, bool is_result, bool is_x_factory) {
...
void t_delphi7_generator::generate_delphi_struct_type_factory_registration( ostream& out, string cls_prefix, t_struct* tstruct, bool is_exception, bool is_result, bool is_x_factory) {
	if (is_exception)
		return;
	if (is_result)
		return;
...
void t_delphi7_generator::generate_delphi_struct_definition(ostream &out, t_struct* tstruct, bool is_exception, bool in_class, bool is_result, bool is_x_factory) {
...
void t_delphi7_generator::generate_service(t_service* tservice) {
  indent_up();
...
void t_delphi7_generator::generate_service_interface(t_service* tservice) {
  string extends = "";
...
void t_delphi7_generator::generate_service_helpers(t_service* tservice) {
  vector<t_function*> functions = tservice->get_functions();
  vector<t_function*>::iterator f_iter;
...
void t_delphi7_generator::generate_service_client(t_service* tservice) {
  indent_up();
  string extends = "";
...
void t_delphi7_generator::generate_service_server(t_service* tservice) {
  vector<t_function*> functions = tservice->get_functions();
  vector<t_function*>::iterator f_iter;
...
void t_delphi7_generator::generate_function_helpers(t_function* tfunction) {
...
void t_delphi7_generator::generate_process_function(t_service* tservice, t_function* tfunction) {
  (void) tservice;
...
void t_delphi7_generator::generate_deserialize_field(ostream& out, bool is_xception, t_field* tfield, string prefix, ostream& local_vars) {
...
void t_delphi7_generator::generate_deserialize_struct(ostream& out, t_struct* tstruct, string name, string prefix) {
  string typ_name;
...
void t_delphi7_generator::generate_deserialize_container(ostream& out, bool is_xception, t_type* ttype, string name, std::ostream& local_vars) {
...
void t_delphi7_generator::generate_deserialize_map_element(ostream& out, bool is_xception, t_map* tmap, string prefix, ostream& local_vars) {
...
void t_delphi7_generator::generate_deserialize_set_element(ostream& out, bool is_xception, t_set* tset, string prefix, ostream& local_vars) {
...
void t_delphi7_generator::generate_deserialize_list_element(ostream& out, bool is_xception, t_list* tlist, string prefix, ostream& local_vars) {
  string elem = tmp("_elem");
...
void t_delphi7_generator::generate_serialize_struct(ostream& out, t_struct* tstruct, string prefix, ostream& local_vars) {
  (void) local_vars;
  (void) tstruct;
  out <<
...
std::string t_delphi7_generator::prop_name(t_field* tfield, bool is_xception) {
  return  prop_name(tfield->get_name(), is_xception);
}

std::string t_delphi7_generator::prop_name(string name, bool is_xception) {
  string ret = name;
  ret[0] = toupper(ret[0]);
  return normalize_name( ret, true, is_xception);
}

std::string t_delphi7_generator::constructor_param_name(string name) {
  string ret = name;
  ret[0] = toupper(ret[0]);
  ret = "A" + ret;
...
string t_delphi7_generator::normalize_clsnm(string clsnm, string prefix, bool b_no_check_keyword) {
  if (clsnm.size() > 0) {
...
string t_delphi7_generator::type_name( t_type* ttype, bool b_cls, bool b_no_postfix, bool b_exception_factory, bool b_full_exception_factory) {
...
string t_delphi7_generator::input_arg_prefix( t_type* ttype) {
...
string t_delphi7_generator::base_type_name(t_base_type* tbase) {
...
string t_delphi7_generator::declare_field(t_field* tfield, bool init, std::string prefix, bool is_xception_class) {
  (void) init;
...
string t_delphi7_generator::function_signature(t_function* tfunction, std::string full_cls, bool is_xception) {
...
string t_delphi7_generator::argument_list(t_struct* tstruct) {
  string result = "";
...
string t_delphi7_generator::constructor_argument_list(t_struct* tstruct, string current_indent) {
...
string t_delphi7_generator::type_to_enum(t_type* type) {
  while (type->is_typedef()) {
    type = ((t_typedef*)type)->get_type();
  }
...
string t_delphi7_generator::empty_value(t_type* type) {
  while (type->is_typedef()) {
    type = ((t_typedef*)type)->get_type();
  }
...
void t_delphi7_generator::generate_delphi_property_writer_definition(ostream& out, t_field* tfield, bool is_xception_class) {
  t_type * ftype = tfield->get_type();
  bool is_xception = ftype->is_xception();
...
void t_delphi7_generator::generate_delphi_property_reader_definition(ostream& out, t_field* tfield, bool is_xception_class) {
  t_type * ftype = tfield->get_type();
  bool is_xception = ftype->is_xception();
...
void t_delphi7_generator::generate_delphi_isset_reader_definition(ostream& out, t_field* tfield, bool is_xception) {
  indent(out) << "function Get__isset_" << prop_name( tfield, is_xception) << ": Boolean;" << endl;
}

void t_delphi7_generator::generate_delphi_clear_union_value(ostream& out, std::string cls_prefix, std::string name, t_type* type, t_field* tfield, std::string fieldPrefix, bool is_xception_class, bool is_union, bool is_xception_factory, std::string xception_factroy_name) {
  (void) type;
...
void t_delphi7_generator::generate_delphi_property_writer_impl(ostream& out, std::string cls_prefix, std::string name, t_type* type, t_field* tfield, std::string fieldPrefix, bool is_xception_class, bool is_union, bool is_xception_factory, std::string xception_factroy_name) {
  (void) type;
...
void t_delphi7_generator::generate_delphi_property_reader_impl(ostream& out, std::string cls_prefix, std::string name, t_type* type, t_field* tfield, std::string fieldPrefix, bool is_xception_class) {
  (void) type;
...
void t_delphi7_generator::generate_delphi_isset_reader_impl(ostream& out, std::string cls_prefix, std::string name, t_type* type, t_field* tfield, std::string fieldPrefix, bool is_xception) {
  (void) type;
...
void t_delphi7_generator::generate_delphi_create_exception_impl(ostream& out, string cls_prefix, t_struct* tstruct, bool is_exception) {
  (void) cls_prefix;
...
void t_delphi7_generator::generate_delphi_struct_reader_impl(ostream& out, string cls_prefix, t_struct* tstruct, bool is_exception) {
...
void t_delphi7_generator::generate_delphi_struct_result_writer_impl(ostream& out, string cls_prefix, t_struct* tstruct, bool is_exception) {
...
void t_delphi7_generator::generate_delphi_struct_writer_impl(ostream& out, string cls_prefix, t_struct* tstruct, bool is_exception) {
...
void t_delphi7_generator::generate_delphi_struct_tostring_impl(ostream& out, string cls_prefix, t_struct* tstruct, bool is_exception, bool is_x_factory) {
...
bool t_delphi7_generator::is_void( t_type* type ) {
  while (type->is_typedef()) {
    type = ((t_typedef*)type)->get_type();
  }
...
THRIFT_REGISTER_GENERATOR(delphi7, "delphi7", 
